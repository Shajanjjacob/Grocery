...
def admin_add_category_view(request):
    ...
    return render(request,'admin_add_category.html',context=mydict)
...
def admin_view_category_view(request):
    ...
    return render(request,'admin_view_category.html',context=mydict)
...
def update_category_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if form1.is_valid():
            ...
            print('form invalid')
        return HttpResponseRedirect('/admin-view-category')
    return render(request,'admin_update_category.html',context=mydict)
...
def admin_view_product_view(request):
    ...
    return render(request,'admin_view_product.html',context=mydict)
...
def customer_view_product_by_category_view(request,pk):
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'customer_view_products_by_category.html',context=mydict)
...
def all_product_view(request):
    ...
    return render(request,'all_product.html',context=mydict)
...
def order_product_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if form1.is_valid():
            ...
            order.save()
            return render(request,'order_placed.html',context=mydict)
    return render(request,'place_order.html',context=mydict)
